...
functions infer result types at binding. Bound evaluation validates every
returned value. `native_ops` certifies comparison and hash semantics only; it
does not skip result validation.
